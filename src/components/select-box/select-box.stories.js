...
const formStyles = `<style>
  *,*::before,*::after{box-sizing:border-box}
  ...
  .select-wrap::after{content:'';position:absolute;right:var(--sp-16);top:50%;transform:translateY(-50%) rotate(45deg);width:8px;height:8px;border-right:2px solid var(--color-charcoal-60);border-bottom:2px solid var(--color-charcoal-60);pointer-events:none}
  select.input{padding-inline-end:var(--sp-48);cursor:pointer}
</style>`;
